var config = {
    ...
    byline: `Tucked between the hills of Yokosuka are the yato — residential alcoves that were, until recently, only reachable through a single entrance, their interiors hidden from the street. Built as the naval arsenal expanded through the Taishō and early Shōwa periods, these valleys filled with the density of workers' lives: houses pressed deep into the hillside, neighbourhoods that faced inward by necessity. At their peak in 2003, 430,274 people lived in this city. Today, 365,970 do. The difference is legible in the yato: doors sealed, gardens returned to brush, houses stranded at the end of paths that no longer lead anywhere.
Yato are frequently cited as a symptomatic landscape of Japan's depopulation — places where demographic decline is most visibly concentrated. But this framing misses something structurally significant. The yato of Yokosuka did not develop alongside any ordinary industry. Their geography was shaped in direct relation to the naval arsenal and the wars of the twentieth century, and that history has not simply passed. It has been inscribed into the soil, the topography, the materials of the landscape itself.
Project Yato begins from a different premise: that the geographical conditions of these alcoves are not a problem to be diagnosed, but a set of tensions to be read. It is an exercise in turning geography into historiography — in finding new ways to record the past so that Yokosuka becomes more than a naval port, and its story more than the navy curry, the warships in the harbour, and the memorial plaques that mark official grief at official sites. The project puts the theory of bamen (場面) into cartographical practice: using visual and map-based storytelling to reveal the invisible structures of historical tension that the landscape carries, and to document how residents work on and with their materials — or how, in their absence, nature quietly reclaims what presence once organised.`,
    footer: '',
    chapters: [
        {
            id: 'intro',
