var config = {
    ...
    byline: `<p style="margin-bottom: 1.6em;">Tucked between the hills of Yokosuka are the yato — residential alcoves that were, until recently, only reachable through a single entrance, their interiors hidden from the street. Built as the Naval Arsenal expanded through the Taishō and early Shōwa periods, these valleys are filled with the density of workers' lives: houses pressed deep into the hillside, neighbourhoods that faced inward by necessity. Yato are frequently cited as a symptomatic landscape of Japan's depopulation — places where decline has gone furthest and become most visible at once. In some areas, nearly 20% of houses stand empty: doors sealed, gardens returned to brush, houses stranded at the end of paths that no longer lead anywhere.</p>
        <p style="margin-bottom: 1.6em;">But this framing misses something structurally significant. The terrain of yato was already part of the trade and political routes connecting the coast to Edo, and the yato communities that took shape later grew alongside the Naval Arsenal that drew workers, soldiers, and merchants from across the country. These histories did not arrive continuously. But they do not disappear either — they are inscribed into the soil, the topography, the materials of the landscape itself. Nor does the framing do justice to the parts of yato's neighborhoods and streets that are carefully tended and maintained. What makes yato so irresistibly enchanting is these multiple tensions in its history, topography, and ecology.</p>
        <p style="margin-bottom: 1.6em;">The collection of bamen departs from the premise that the yato areas are not a problem to be diagnosed, but a set of tensions to be read. It is an exercise in turning geography into historiography — in discovering how Yokosuka is already more than a naval port, and its story more than the navy curry, the warships in the harbour, and the memorial plaques that mark official grief at official sites. To do that, this project puts the theory of bamen (場面) into cartographic practice: using map-based storytelling to reveal the invisible historical, topographical, and ecological tensions the landscape carries, while documenting the creative initiatives already underway — or, where those are absent, the way nature quietly reclaims what human presence once organised.</p>`,
    footer: '',
    chapters: [
        {
            id: 'intro',
