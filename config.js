var config = {
    ...
    theme: 'light',
    use3dTerrain: false,
    title: 'Bringing Literature to the Yato Landscape,<br>Reading the Yato Landscape through Literature',
    subtitle: 'Planting and Walking in a Forest of Bamen',
